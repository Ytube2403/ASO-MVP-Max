# 🚀 ASO Keyword Filter Pipeline & Tracker (ASO-MVP) v3.6
...
### 1. Pipeline Lọc Từ Khóa ASO (v3.6)
...
│   ├── keyword_filter.py    (Logic bộ lọc cứng, chấm điểm relevancy & phân loại bucket)
│   └── text_dedup.py        (Dedup Unicode đa ngôn ngữ, stemming theo locale & review log)
│
