# 🚀 ASO Keyword Filter Pipeline & Tracker (ASO-MVP) v3.5
...
### 1. Pipeline Lọc Từ Khóa ASO (v3.5)
...
* Cài đặt các thư viện phụ thuộc:
  ```powershell
  pip install flask openpyxl pandas langdetect
  ```
